/**
 * Class for all main menu options
...
public class Dev_MenuOption extends Dev_MainMenu {
     ...
     * @throws Exception for unforseen errors
     */
    public void addCustomer() throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        ArrayList<Integer> list1 = getRandomNonRepeatingIntegers(1, 10000, 19999);
        ...
        do {
            ...
            System.out.println("> O/o for Others");
            ...
            try {
                ...
                } while (Date == false || Month == false || Year == false);
            } catch (Exception e) {
                e.printStackTrace();
            }
            dob = date + "/" + month + "/" + year;
        ...
        cDetails = name + "\t" + gender + "\t" + dob + "\t" + address + "\t" + city + "\t" + state + "\t" + pin + "\t"
                + mobileNo + "\t" + email;
    ...
    /**
     * Allows editing of customer profile
    ...
    public void editCustomers() throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            if (cusIn == entry.getKey()) {
                ...
                String update = at[0] + "\t" + at[1] + "\t" + at[2] + "\t" + at[3] + "\t" + at[4] + "\t" + at[5] + "\t"
                        + at[6] + "\t" + at[7] + "\t" + at[8];
     ...
     * @return returns the entire object of type Dev_Account
     */
    ...
    /**
     * Allows for opening account
     */
    public void openAccount() {
        if (acCount == TOTAL_ACCTS_LIMIT) {
            System.out.println("Limit reached, can't create more than " + TOTAL_ACCTS_LIMIT + " accounts");
            return;
        }
        Iterator<Map.Entry<Integer, String>> itr = lhm.entrySet().iterator();
        boolean cusPresent = false;
    ...
    /**
     * used to create an array of account numbers
     * @param size defines size of array
     * @param min defines minimum value of random int
     * @param max defines maximum value of random int
     * @return returns an array of randomly generated numbers
     */
    ...
    /**
     * Method to enquire about balance in an account
     */
    ...
    public void displayAllAccounts() {
        ...
        for (int i = 0; i < acCount; i++) {
            System.out.println(accts[i].getAcNo() + "\t" + accts[i].getAcHolder() + "\t" + accts[i].getAcType() + "\t"
                    + accts[i].getAcBal());
        }
        System.out.println();
    }
